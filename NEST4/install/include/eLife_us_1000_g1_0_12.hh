...
#ifndef eLife_us_1000_g1_0_12_hh
#define eLife_us_1000_g1_0_12_hh 1

#include "VDetector.hh"

using namespace std;

class eLife_us_1000_g1_0_12 : public VDetector {
 public:
  eLife_us_1000_g1_0_12() {
    cerr << "*** Detector definition message ***" << endl;
    cerr << "You are currently using the eLife_us_1000_g1_0_12 detector."
         << endl
         << endl;
  ...
  virtual ~eLife_us_1000_g1_0_12(){};

  // Do here the initialization of all the parameters that are not varying as a
  // function of time
  virtual void Initialization() {
    // Primary Scintillation (S1) parameters
    g1 = 0.12;//  // phd per S1 phot at dtCntr (not phe). Divide out 2-PE effect
    ...
    TopDrift = 3005.3;//  // mm not cm or us (but, this *is* where dt=0)
    ...
    // above it
    gate = 3004.3;//  // mm. This is where the E-field changes (higher)
