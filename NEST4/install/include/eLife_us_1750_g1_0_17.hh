...
#ifndef eLife_us_1750_g1_0_17_hh
#define eLife_us_1750_g1_0_17_hh 1

#include "VDetector.hh"

using namespace std;

class eLife_us_1750_g1_0_17 : public VDetector {
 public:
  eLife_us_1750_g1_0_17() {
    cerr << "*** Detector definition message ***" << endl;
    cerr << "You are currently using the eLife_us_1750_g1_0_17 detector."
         << endl
         << endl;
  ...
  virtual void Initialization() {
    ...
    eLife_us = 1750;  // the drift electron mean lifetime in micro-seconds
