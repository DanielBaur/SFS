...
double minS1 = 0.5; //1.5 //units are controlled by the usePE flag
// this is separate from S1 thresholds controlled by detector
double maxS1 = 1500.5; // changed from 99.5
int numBins = 150; //98; //for LUXRun03 DD, change these to 1.7,110.6,99

// for efficiency calculation
// minS2 need not match S2 threshold in detector.hh
// you can treat as trigger vs. analysis thresholds
double minS2 = 0.5;//42.
double maxS2 = 1e9; // changed from 1e4 //5e3 for DD. At least 2e5 for post-Run04 14C

// log(S2/S1) or log(S2) admitted into analysis incl. limit
double logMax = 15.1; // changed from 3.6; //when skewness=1 or 2 ROOT ignores these and does raw mean +/- 3-sigma
double logMin = 0.1; // changed from 0.6;
int logBins = 150; //#bins in between logMin & logMax for fits
