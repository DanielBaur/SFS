...
#ifndef eLife_us_1100_g1_0_13_hh
#define eLife_us_1100_g1_0_13_hh 1
...
class eLife_us_1100_g1_0_13 : public VDetector {
  
public:
  
  eLife_us_1100_g1_0_13() {
    if ( verbosity ) cerr << "*** Detector definition message ***" << endl;
    cerr << "You are currently using the eLife_us_1100_g1_0_13 detector.";
    
    // Call the initialization of all the parameters
    Initialization();
  };
  virtual ~eLife_us_1100_g1_0_13(){};
