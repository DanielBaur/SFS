...
#ifndef eLife_us_1200_g1_0_13_hh
#define eLife_us_1200_g1_0_13_hh 1
...
class eLife_us_1200_g1_0_13 : public VDetector {
  
public:
  
  eLife_us_1200_g1_0_13() {
    if ( verbosity ) cerr << "*** Detector definition message ***" << endl;
    cerr << "You are currently using the eLife_us_1200_g1_0_13 detector.";
    
    // Call the initialization of all the parameters
    Initialization();
  };
  virtual ~eLife_us_1200_g1_0_13(){};
  
  // Do here the initialization of all the parameters that are not varying as a function of time
  virtual void Initialization() {
    
    // Primary Scintillation (S1) parameters
    g1 = 0.13;// //0.117+/-0.003 WS,0.115+/-0.005 D-D,0.115+/-0.005 CH3T,0.119+/-0.001 LUXSim
    ...
    eLife_us = 1200;// //p.44 of James Verbus PhD thesis Brown
