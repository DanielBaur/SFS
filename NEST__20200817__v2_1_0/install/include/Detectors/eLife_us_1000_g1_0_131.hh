...
#ifndef eLife_us_1000_g1_0_131_hh
#define eLife_us_1000_g1_0_131_hh 1
...
class eLife_us_1000_g1_0_131 : public VDetector {
  
public:
  
  eLife_us_1000_g1_0_131() {
    if ( verbosity ) cerr << "*** Detector definition message ***" << endl;
    cerr << "You are currently using the eLife_us_1000_g1_0_131 detector.";
    
    // Call the initialization of all the parameters
    Initialization();
  };
  virtual ~eLife_us_1000_g1_0_131(){};
  
  // Do here the initialization of all the parameters that are not varying as a function of time
  virtual void Initialization() {
    
    // Primary Scintillation (S1) parameters
    g1 = 0.131;// //0.117+/-0.003 WS,0.115+/-0.005 D-D,0.115+/-0.005 CH3T,0.119+/-0.001 LUXSim
    ...
    eLife_us = 1000;// //p.44 of James Verbus PhD thesis Brown
