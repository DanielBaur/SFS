...
#ifndef darwin_firsttest_hh
#define darwin_firsttest_hh 1

#include "VDetector.hh"

using namespace std;

class darwin_firsttest : public VDetector {
 public:
  darwin_firsttest() {
    cerr << "*** Detector definition message ***" << endl;
    cerr << "You are currently using the darwin_firsttest detector."
         << endl
         << endl;
