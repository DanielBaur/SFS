...
#ifndef g1_0_11_eLife_us_2250_hh
#define g1_0_11_eLife_us_2250_hh 1

#include "VDetector.hh"

using namespace std;

class g1_0_11_eLife_us_2250 : public VDetector {
 public:
  g1_0_11_eLife_us_2250() {
    cerr << "*** Detector definition message ***" << endl;
    cerr << "You are currently using the g1_0_11_eLife_us_2250 detector."
         << endl
         << endl;
  ...
  virtual void Initialization() {
    ...
    eLife_us = 2250;  // the drift electron mean lifetime in micro-seconds
