...
#ifndef eLife_us_2000_g1_0_15_hh
#define eLife_us_2000_g1_0_15_hh 1

#include "VDetector.hh"

using namespace std;

class eLife_us_2000_g1_0_15 : public VDetector {
 public:
  eLife_us_2000_g1_0_15() {
    cerr << "*** Detector definition message ***" << endl;
    cerr << "You are currently using the eLife_us_2000_g1_0_15 detector."
         << endl
         << endl;
  ...
  virtual void Initialization() {
    ...
    eLife_us = 2000;  // the drift electron mean lifetime in micro-seconds
