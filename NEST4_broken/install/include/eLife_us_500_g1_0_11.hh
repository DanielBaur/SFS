...
#ifndef eLife_us_500_g1_0_11_hh
#define eLife_us_500_g1_0_11_hh 1

#include "VDetector.hh"

using namespace std;

class eLife_us_500_g1_0_11 : public VDetector {
 public:
  eLife_us_500_g1_0_11() {
    cerr << "*** Detector definition message ***" << endl;
    cerr << "You are currently using the eLife_us_500_g1_0_11 detector."
         << endl
         << endl;
  ...
  virtual void Initialization() {
    ...
    eLife_us = 500;  // the drift electron mean lifetime in micro-seconds
