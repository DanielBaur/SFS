...
#ifndef g1_0_13__eLife_us_2300_hh
#define g1_0_13__eLife_us_2300_hh 1

#include "VDetector.hh"

using namespace std;

class g1_0_13__eLife_us_2300 : public VDetector {
 public:
  g1_0_13__eLife_us_2300() {
    cerr << "*** Detector definition message ***" << endl;
    cerr << "You are currently using the g1_0_13__eLife_us_2300 detector."
         << endl
         << endl;
  ...
  virtual ~g1_0_13__eLife_us_2300(){};

  // Do here the initialization of all the parameters that are not varying as a
  // function of time
  virtual void Initialization() {
    // Primary Scintillation (S1) parameters
    g1 = 0.13;  // phd per S1 phot at dtCntr (not phe). Divide out 2-PE effect
