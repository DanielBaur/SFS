...
#ifndef detector_g1__0_17__eLife_us__2300_hh
#define detector_g1__0_17__eLife_us__2300_hh 1

#include "VDetector.hh"

using namespace std;

class detector_g1__0_17__eLife_us__2300 : public VDetector {
 public:
  detector_g1__0_17__eLife_us__2300() {
    cerr << "*** Detector definition message ***" << endl;
    cerr << "You are currently using the detector_g1__0_17__eLife_us__2300 detector."
         << endl
         << endl;
  ...
  virtual ~detector_g1__0_17__eLife_us__2300(){};

  // Do here the initialization of all the parameters that are not varying as a
  // function of time
  virtual void Initialization() {
    // Primary Scintillation (S1) parameters
    g1 = 0.17;  // phd per S1 phot at dtCntr (not phe). Divide out 2-PE effect
    ...
    eLife_us = 2300;  // the drift electron mean lifetime in micro-seconds
